        ...
        <div className="login-layout">
          ...
          <GlassPanel className="login-card">
            <div className="login-title">
              ...
              <p>Access your secure digital vault.</p>
            </div>
          ...
          <GlassPanel className="vault-card">
            ...
            >
              {loginStatus === "unlocked" ? (
                <UnlockKeyhole size={48} strokeWidth={1.6} />
              ) : (
            ...
            <p className="vault-message">Your secrets are waiting.</p>

            <div className="vault-divider"></div>

            <div
              className={`vault-status ${
                loginStatus === "unlocked" ? "status-unlocked" : ""
              }`}
            >
              {loginStatus === "unlocked" ? "UNLOCKED" : "LOCKED"}
            </div>

            {isLoading && (
              <p className="authenticating-text">Authenticating...</p>
            )}
          </GlassPanel>
        </div>
      </div>
